    ...
    >
      ...
      <div class="relative bg-black/40 backdrop-blur-lg border border-pink-500/20 rounded-3xl p-8 glass-effect hover-glow">
        ...
        <div class="mb-6 pr-20">
          ...
          <p class="text-lg font-semibold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent mb-2">
            {{ institution }}
          </p>
        </div>
        
        <!-- Period, Location and Academic Performance -->
        <div class="mb-6">
        ...
        <!-- TCC Section (only for graduation) -->
        <div v-if="type === 'graduation' && tccInfo" class="mb-6 bg-gradient-to-r from-blue-900/20 to-indigo-900/20 border border-blue-500/30 rounded-2xl p-4">
